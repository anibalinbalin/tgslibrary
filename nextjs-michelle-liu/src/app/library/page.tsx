...
function BookCard({ book, onClick }: { book: Book; onClick: () => void }) {
  return (
    <div className="relative cursor-pointer group" onClick={onClick}>
      {/* Book cover */}
      <div className="relative w-[120px] h-[180px] rounded-[4px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.1)] transition-all duration-[400ms] ease-out group-hover:scale-[1.025] group-hover:-translate-y-3 group-hover:shadow-none overflow-hidden bg-gray-100">
        {book.coverImage ? (
          <img
            alt={book.title}
          ...
          <div className="absolute inset-0 flex items-center justify-center p-3 text-center bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 content-stretch flex flex-col gap-[24px] sm:gap-[32px] md:gap-[40px] items-start p-[24px] sm:p-[40px] md:p-[60px] lg:p-[80px] xl:p-[100px] rounded-[16px] sm:rounded-[18px] md:rounded-[20px] w-[calc(100vw-32px)] sm:w-[calc(100vw-80px)] md:w-[min(800px,90vw)] max-h-[calc(100vh-32px)] sm:max-h-[90vh] overflow-y-auto bg-white">
        ...
        <div className="content-stretch flex flex-col sm:flex-row gap-[32px] sm:gap-[36px] md:gap-[44px] items-start relative shrink-0 w-full">
          {book.goodreadsUrl ? (
            ...
            >
              <div className="absolute h-[219px] left-0 rounded-[6px] top-0 w-[142.004px] transition-transform duration-300 group-hover:rotate-[2.5deg] overflow-hidden bg-gray-100">
                {book.coverImage ? (
                  ...
                  <div className="absolute inset-0 flex items-center justify-center p-4 text-center bg-gradient-to-br from-gray-100 to-gray-200 rounded-[6px]">
        ...
        <div className="pt-[32px] px-[60px]">
          <div className="flex justify-between items-start pb-[32px]">
            <div className="flex flex-col gap-2 items-start">
              <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[34px] text-[28px] text-black tracking-[0.38px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                {t('library')}
              </p>
              <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[22px] text-[17px] text-[rgba(0,0,0,0.4)] tracking-[-0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            ...
            {isLoading ? (
              <div className="flex items-center justify-center min-h-[300px]">
                <div className="flex flex-col items-center gap-4">
                  ...
                  <p className="font-['SF_Pro:Regular',sans-serif] text-[16px] text-[rgba(0,0,0,0.4)]">{t('loading')}</p>
                </div>
              </div>
            ) : books.length === 0 ? (
              <div className="flex items-center justify-center min-h-[300px]">
