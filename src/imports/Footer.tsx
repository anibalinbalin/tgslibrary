import svgPaths from "./svg-d8behdpb4h";
import imgFinalSealLogo1 from "figma:asset/a76eb5a0f18de2c3b9c2ac1e18fa0165affdd477.png";
import { imgGroup } from "./svg-4m3d0";

function SocialLinks({ children }: React.PropsWithChildren<{}>) {
  return (
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[60px] items-center px-[32px] py-[60px] relative size-full">
          <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
            ...
            <div className="gap-[20px] grid grid-cols-[repeat(2,_minmax(0px,_1fr))] grid-rows-[repeat(1,_fit-content(100%))] relative shrink-0 w-full">
              ...
              <div className="[grid-area:1_/_2] content-stretch flex items-start justify-between relative self-start shrink-0 w-[678px]">
