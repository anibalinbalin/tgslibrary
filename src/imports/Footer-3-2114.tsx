  ...
  return (
    <div className="relative size-full" data-name="Footer">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[60px] items-center pb-[60px] pt-[16px] px-[16px] relative size-full">
