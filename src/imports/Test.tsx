        ...
        <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0 w-full">
          <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
            <div className="content-stretch flex gap-[6px] items-center relative shrink-0 text-nowrap">
              <p className="font-['Figtree:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[20px] text-black">Project Title</p>
              <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[1.4] relative shrink-0 text-[#9ca3af] text-[16px]">•</p>
              <p className="font-['Figtree:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#9ca3af] text-[20px]">Year</p>
            </div>
          ...
          <p className="font-['Figtree:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#6b7280] text-[16px] w-full">Description</p>
        </div>
