...
import img from "figma:asset/a76eb5a0f18de2c3b9c2ac1e18fa0165affdd477.png";
...
function Frame1086331LinksBackgroundImageAndText({ text }: Frame1086331LinksBackgroundImageAndTextProps) {
  return (
    <button className="content-stretch flex items-center justify-center px-[2px] py-0 relative rounded-[999px] shrink-0">
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#9ca3af] text-[16px] text-left text-nowrap tracking-[0.16px]">{text}</p>
    </button>
  );
}
...
function Frame1086307TagBackgroundImageAndText({ text }: Frame1086307TagBackgroundImageAndTextProps) {
  return (
    <button className="content-stretch cursor-pointer flex items-center justify-center px-[12px] py-[4px] relative rounded-[999px] shrink-0">
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#9ca3af] text-[16px] text-left text-nowrap tracking-[0.16px]">{text}</p>
    </button>
  );
}
              ...
              <div className="content-stretch flex flex-col gap-[36px] items-start pb-[16px] pt-[44px] px-[32px] relative w-full">
                <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
                  ...
                  <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[28px] not-italic relative shrink-0 text-[#6b7280] text-[0px] text-[20px] w-full">
                    <span className="font-['Figtree:Regular',sans-serif] text-[#9ca3af]">{`Designing useful products to spark moments of delight & `}</span>
