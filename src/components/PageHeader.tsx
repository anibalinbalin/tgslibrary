...
export default function PageHeader({
  ...
  return (
    ...
    >
      ...
      <div className="relative shrink-0 w-full" style={{ zIndex: 2 }}>
        <div className="size-full">
          <div className="content-stretch flex flex-col gap-4 items-start pb-6 pt-14 px-16 max-md:px-8 max-md:pt-8 max-md:pb-4 relative w-full max-md:h-[220px]">
            <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
              ...
              {children && (
                <ScrollReveal variant="fade" delay={150} rootMargin="0px" disabled={heroAnimationPlayed}>
                  <div className="font-['Figtree',sans-serif] font-normal tracking-wide leading-6.5 text-[#9ca3af] text-lg max-md:text-lg w-full max-md:max-w-80 whitespace-pre-wrap mt-1 max-md:mt-1">
                    {children}
                  </div>
                </ScrollReveal>
              )}
